...
test("a template change reaches the project, and the project's own changes stay", () => {
  ...
  assert.doesNotMatch(readFileSync(join(dir, "SECURITY.md"), "utf8"), /hynix666\/TEMPLATE1/);
  const changelog = readFileSync(join(dir, "CHANGELOG.md"), "utf8");
  assert.match(changelog, new RegExp(`Updated to \\[TEMPLATE1 ${TO.replaceAll(".", "\\.")}\\]`));
...
test("the origin line is read the way every release since v1.0.0 wrote it", () => {
  const changelog = [
    "## [Unreleased]",
    "",
    "- Updated to [TEMPLATE1 v1.4.0](https://github.com/hynix666/TEMPLATE1/releases/tag/v1.4.0).",
    "- Initialized from [ULTRA-TEMPLATE v1.0.0](https://github.com/hynix666/ULTRA-TEMPLATE/releases/tag/v1.0.0) with go-service, release.",
  ].join("\n");
  ...
  assert.equal(readOrigin(recordUpdate("## [Unreleased]\n\n- Initialized from [TEMPLATE1 v1.3.1](https://github.com/hynix666/TEMPLATE1/releases/tag/v1.3.1) with no features.\n", "https://github.com/hynix666/TEMPLATE1", "v1.4.0")).version, "v1.4.0");
