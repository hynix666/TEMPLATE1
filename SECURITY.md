...
Report it privately: **[Report a vulnerability](https://github.com/hynix666/TEMPLATE1/security/advisories/new)** (Security tab → *Report a vulnerability*). If the link says reporting is off, a maintainer enables it with `node scripts/configure-github.mjs` or under Settings → Code security → Private vulnerability reporting.
